...
| `encoding/README.md` | Index for instruction-family encoding notes. |
...
The formal Phase 3 pattern library lives outside this directory in `patterns/`. Use `patterns/README.md` for audit-facing signatures and `knowledge/FINDINGS.md` for the full evidence trail behind each pattern.
